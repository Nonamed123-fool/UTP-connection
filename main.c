...
//  lab
//
//  Created by David Sovann on 29/7/2025.
//
...
The server port number as the last four digits of student nubmer (as long as it is above 1024 add 1024 if it is not).
This should minimise server port number clashes with other students sharing the machine.
